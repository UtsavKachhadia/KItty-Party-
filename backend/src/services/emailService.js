...
/**
 * Email transport — uses Ethereal (free test SMTP) in development
 * so emails always "send" without needing real SMTP credentials.
 * In production, replace with real SMTP (SendGrid, SES, etc.).
 */
